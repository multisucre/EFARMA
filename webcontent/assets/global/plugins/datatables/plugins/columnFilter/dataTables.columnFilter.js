...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
            ...
            oTable.dataTableExt.afnFiltering.push(
                function (oSettings, aData, iDataIndex) {
                    ...
                    try {
                        ...
                        //dCellDate = Date.parse(aData[_fnColumnIndex(index)]);
                        var tiempoHora = aData[_fnColumnIndex(index)].split(/\s+/);
                        var parts = tiempoHora[1].split('/');
                        var dateObject = new Date(parts[2], parts[1] - 1, parts[0]);
                        dCellDate = dateObject.getTime();
                    } catch (ex) {
                        console.log(ex);
                        return false;
                    }
        ...
        function fnCreateDropdown(aData) {
            var index = i;
            var r = '<div class="dropdown select_filter form-control"><a class="dropdown-toggle" data-toggle="dropdown" href="#">' + label + '<b class="caret"></b></a><ul class="dropdown-menu" role="menu"><li data-value=""><a>Show All</a></li>',
                j, iLen = aData.length;
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            r += '<div id="' + checkToggleDiv + '" ' + 'title="' + label + '" ' + 'rel="' + i + '" ' + 'class="toggle-check ui-widget-content ui-corner-all"  style="width: ' + (divWidthToggle) + '%; " >'; //dialog div
